...
public class ComponentActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    arFragment = (ArFragment) getSupportFragmentManager().findFragmentById(R.id.arc);

    WeakReference<ComponentActivity> weakActivity = new WeakReference<>(this);

    ModelRenderable.builder()
        .setSource(this, Uri.parse("chair.glb"))
        .setIsFilamentGltf(true)
        .build()
        .thenAccept(
            modelRenderable -> {
              ComponentActivity activity = weakActivity.get();
              if (activity != null) {
